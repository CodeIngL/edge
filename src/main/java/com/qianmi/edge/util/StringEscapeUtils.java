...
public class StringEscapeUtils {
     ...
     * @throws java.io.IOException when <code>Writer</code> passed throws the exception from
     *                                       calls to the {@link java.io.Writer#write(int)} methods.
     *
     ...
     * @param str  the <code>String</code> to unescape, may be null
     * @return a new unescaped <code>String</code>, <code>null</code> if null string input
     * @see #escapeHtml(java.io.Writer, String)
     */
